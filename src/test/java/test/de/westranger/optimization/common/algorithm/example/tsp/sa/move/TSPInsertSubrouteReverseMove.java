...
public final class TSPInsertSubrouteReverseMove extends TSPMove {

  public TSPInsertSubrouteReverseMove(final Random rng, final RouteEvaluator routeEvaluator) {
  ...
  public Optional<TSPMoveResult> performMove(final VehicleRoute vrA, final VehicleRoute vrB) {
    ...
    for (int i = min; i <= max; i++) {
      subroute.add(lstA.remove(max - i - min));
    }
